...
using Tyuiu.IvashkinaKE.Sprint1.Task0.V16.Lib;

namespace Tyuiu.IvashkinaKE.Sprint1.Task0.V16
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* (6 / 2 / 3) + 1 - (6 / 2 * 3) и печатает результат на экране            *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
